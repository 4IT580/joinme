        ...
        <div className="bordered rounded-xl bg-gray-200 m-2 pt-4 pb-2 px-4 w-96 max-w-md">
          ...
          <div className="w-full flex flex-row justify-around py-4">
            <div
              ...
              className={`border-black cursor-pointer bordered rounded-xl px-4 p-2 mr-2 w-1/2 text-center ${
                tab === 'joined' ? 'bg-gray-900 text-white' : 'bg-white'
              }`}
            >
            ...
            <div
              ...
              className={`border-black cursor-pointer bordered rounded-xl px-4 p-2 ml-2 w-1/2 text-center ${
                tab === 'myEvents' ? 'bg-gray-900 text-white' : 'bg-white'
              }`}
            >
          ...
          <div>
            {tab === 'joined' && (
              <div>
                {joinedEvents.map((e) => (
                  <EventMiniCard event={e} key={e.id} onClick={() => setActive(e)} />
                ))}
              </div>
            )}
            {tab === 'myEvents' && (
